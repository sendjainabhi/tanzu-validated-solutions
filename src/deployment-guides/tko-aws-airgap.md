...
2. Wait a few minutes for the instance to start. After it restarts, SSH to the jumpbox.
	...
	echo j IP: $(jq -r '.Reservations[0].Instances[0].PublicIpAddress' $WORKING_DIR/instance_jb_started)
